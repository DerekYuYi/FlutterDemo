...
import 'package:starter_iosguides/DataCallAndBackend/models/cartlog.dart';
import 'package:starter_iosguides/DataCallAndBackend/theme.dart';
      ...
      providers: [
        ...
        ChangeNotifierProxyProvider<CatalogModel, CartModel>(
          builder: (context, catalog, previousCart) =>
              CartModel(cartlog, previousCart)),
        ),
      ],
      child: MaterialApp(
        title: 'Provider Demo',
